...
Sources (4 provenance files, glob `*_s0.4.6_*.jsonl`):
- BTCUSDT.P_240_v1_s0.4.6_c553046_B.jsonl
- ETHUSDT.P_240_v1_s0.4.6_c553046_B.jsonl
- NEARUSDT.P_240_v1_s0.4.6_c553046_B.jsonl
- SOLUSDT.P_240_v1_s0.4.6_c553046_B.jsonl
...
**ALL (pooled, no significance claim):** n=30 closed=27 win%=52 avgR=0.96 medMFE=1.42 open=3 | skip_overlap dropped: 13
...
| bucket | n | win% | avg R | med MFE |
|---|---|---|---|---|
| <-1 (stretched dn) | 9 | 56 | 1.24 | 1.72 |
| -1..1 | 11 | 55 | 0.86 | 1.75 |
| >1 (stretched up) | 10 | 43 | 0.77 | 1.00 |
...
| bucket | n | win% | avg R | med MFE |
|---|---|---|---|---|
| <0.2 (chop) | 22 | 50 | 0.82 | 1.25 |
| 0.2-0.45 | 8 | 60 | 1.60 | 1.55 |
| >0.45 (trendy) | 0 | — | — | — |
...
|---|---|---|---|---|
| <0 | 15 | 77 | 1.86 | 2.71 |
| 0-1.5 | 12 | 27 | 0.03 | 0.54 |
| >1.5 (heavy) | 3 | 33 | 0.50 | 0.69 |
...
| bucket | n | win% | avg R | med MFE |
|---|---|---|---|---|
| <0 (shorts pay) | 13 | 40 | 0.39 | 1.09 |
| >=0 (longs pay) | 17 | 59 | 1.30 | 2.71 |
...
| bucket | n | win% | avg R | med MFE |
|---|---|---|---|---|
| swd<0.3 | lq low | 8 | 62 | 1.51 | 3.02 |
| swd<0.3 | lq high | 12 | 45 | 0.89 | 1.55 |
| swd 0.3-0.8 | lq low | 0 | — | — | — |
| swd 0.3-0.8 | lq high | 1 | 0 | -0.04 | 0.51 |
| swd>0.8 | lq low | 0 | — | — | — |
| swd>0.8 | lq high | 0 | — | — | — |
